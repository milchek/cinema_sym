 ...
 */
final class Version20220307111001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        //$this->addSql('ALTER TABLE film ADD date_sortie DATETIME NOT NULL, ADD synopsis LONGTEXT DEFAULT NULL');
    }
